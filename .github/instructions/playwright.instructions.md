...
- **Clarity**: Use descriptive test and step titles that clearly state the intent. Add comments only to explain complex logic or non-obvious interactions, and prefer comments that explain why a scenario matters instead of repeating the code that remains obvious from the test steps.
